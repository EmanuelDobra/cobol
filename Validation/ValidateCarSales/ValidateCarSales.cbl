      ...
      *        REDEFINES F01-SELL      PIC X(6).
       ...
       WORKING-STORAGE SECTION.
		...
		01  W05-ERROR-MESSAGES.
		   05  W05-INVOICE-NOTNUMERIC   PIC X(30) VALUE 
                                   'INVOICE IS NOT NUMERIC OR ZERO'.
           05  W05-SELLPRICE-NOTVALID   PIC X(20) VALUE 
                                   'SELL PRICE NOT VALID'.
		   05  W05-ASKPRICE-NOTNUMERIC  PIC X(32) VALUE 
                                    'ASK PRICE IS NOT NUMERIC OR ZERO'.
		   05  W05-ASKPRICE-OUTOFRANGE  PIC X(34) VALUE 
                                   'ASK PRICE NOT IN 1 TO 500000 RANGE'.
		   05  W05-SELLPRICEGTASKPRICE  PIC X(20) VALUE 
                                    'SELL PRICE IS GT ASK'.
		   05  W05-SELLPRICE-OUTINRANGE PIC X(35) VALUE 
                                  'SELL PRICE NOT IN 1 TO 500000 RANGE'.
		   05  W05-SELLPRICE-NOTNUMERIC PIC X(33) VALUE  
                                    'SELL PRICE IS NOT NUMERIC OR ZERO'.
      ...
      *************
       ...
       ELSE
           MOVE F01-INVOICE-X TO W04-INVOICE-X
       END-IF
       IF F01-INVOICE IS NUMERIC AND F01-INVOICE > 0
           CONTINUE
       ELSE
